...
ESConnector.prototype.buildDeepNestedQueries = function (
  root,
  idName,
  where,
  body,
 ...
 */
ESConnector.prototype.all = function (model, filter, done) {
  const self = this;
 ...
 */
ESConnector.prototype.destroyAll = function (modelName, whereClause, cb) {
  const self = this;
 ...
 */
ESConnector.prototype.updateAll = function (model, where, data, options, cb) {
  const self = this;
  if (self.debug) {
 ...
 * @param {Function} done callback
 */
ESConnector.prototype.count = function (modelName, done, where) {
  const self = this;
 ...
 * @param {Function} done callback
 */
ESConnector.prototype.find = function (modelName, id, done) {
  const self = this;
 ...
 * @param {Function} done callback
 */
ESConnector.prototype.destroy = function (modelName, id, done) {
  const self = this;
  if (self.debug) {
...
ESConnector.prototype.updateAttributes = function (modelName, id, data, callback) {
  const self = this;
  if (self.debug) {
 ...
 */
ESConnector.prototype.updateOrCreate = function (modelName, data, callback) {
  const self = this;
...
ESConnector.prototype.replaceById = function (modelName, id, data, options, callback) {
  const self = this;
