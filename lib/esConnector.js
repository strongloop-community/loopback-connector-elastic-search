...
var ESConnector = function (settings, dataSource) {
  ...
  var doa = dataSource.constructor.DataAccessObject;
  doa = _.assign(doa, {
    bulk: ESConnector.prototype.bulk.bind(this),
    bulkCreate: ESConnector.prototype.bulkCreate.bind(this),
    bulkUpdate: ESConnector.prototype.bulkUpdate.bind(this),
    bulkDestroy: ESConnector.prototype.bulkDestroy.bind(this)
  });
  this.DataAccessObject = doa;
};
...
ESConnector.prototype.bulkCreate = function bulkCreate(modelName, dataList, params, done) {
  ...
  if (Array.isArray(dataList) === false) {
    return done(new Error('invalid type for dataList'));
  }
  ...
  return self.bulk(modelName, bulkParams, done);
};
...
ESConnector.prototype.bulkUpdate = function bulkUpdate(modelName, dataList, params, done){
  ...
  if (Array.isArray(dataList) === false) {
    return new Error('invalid type for dataList');
  }
