 ...
 */
ESConnector.prototype.addDefaults = function (modelName, functionName, options) {
    var self = this;
...
ESConnector.prototype.create = function (model, data, options, done) {
    ...
    var document = self.addDefaults(model, 'create', options);
    ...
    return self.db.create(
        ...
        function (response) {
            ...
            return done(null, response._id); // the connector framework expects the id as a return value
        }, function (err) {
            console.trace(err.message);
            if (err) {
...
ESConnector.prototype.destroyAll = function destroyAll(modelName, whereClause, options, cb) {
    ...
    var defaults = self.addDefaults(modelName, 'destroyAll', options);
...
ESConnector.prototype.count = function count(modelName, where, options, done) {
    ...
    var defaults = self.addDefaults(modelName, 'count', options);
...
ESConnector.prototype.find = function find(modelName, id, options, done) {
    ...
    var defaults = self.addDefaults(modelName, 'find', options);
...
ESConnector.prototype.destroy = function destroy(modelName, id, options, done) {
    ...
    var filter = self.addDefaults(modelName, 'destroy', options);
...
ESConnector.prototype.updateAttributes = function updateAttrs(modelName, id, data, options, callback) {
    ...
    var defaults = self.addDefaults(modelName, 'updateAttributes', options);
...
ESConnector.prototype.exists = function (modelName, id, options, done) {
    ...
    var defaults = self.addDefaults(modelName, 'exists', options);
...
ESConnector.prototype.save = function (model, data, options, done) {
    ...
    var idName = self.idName(model);
    var defaults = self.addDefaults(model, 'save', options);
...
ESConnector.prototype.updateOrCreate = function updateOrCreate(modelName, data, options, callback) {
    ...
    var defaults = self.addDefaults(modelName, 'updateOrCreate', options);
    self.db.update(_.defaults({
        id: id,
        body: {
            doc : data,
